...
export class CdkStack extends Stack {
  constructor(
    ...
    const salableJsSdkCdnBucket = new aws_s3.Bucket(
      this,
      'salableJsSdkCdnBucket',
      {
    ...
    const salableJsSDKCloudfront = new aws_cloudfront.Distribution(
      this,
      'salableJsSdkCdnCloudfront',
      {
        defaultBehavior: {
